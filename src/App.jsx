      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 28, background: "var(--card)", border: "1px solid var(--border)", borderRadius: 10, padding: "10px 12px" }}>
        {navTabs.map(t => (
          <div key={t.id} onClick={() => goTo(t.id)}
            style={{ display: "flex", alignItems: "center", gap: 8, padding: "7px 14px", borderRadius: 6, cursor: "pointer", border: "1px solid transparent", transition: "all 0.15s", position: "relative" }}
            ...
            <span style={{ fontSize: 15, opacity: 0.85 }}>{t.glyph}</span>
            <span style={{ fontFamily: "Cinzel, serif", fontSize: 14, color: "var(--text)", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>{t.label}</span>
